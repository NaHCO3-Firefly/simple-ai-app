...
public class Prefs {
    ...
    public boolean isThinkingEnabled() {
        return sp.getBoolean(KEY_THINKING, true);
    }

    public void setThinkingEnabled(boolean enabled) {
        sp.edit().putBoolean(KEY_THINKING, enabled).apply();
    }

    public String getReasoningEffort() {
        return sp.getString(KEY_REASONING_EFFORT, "medium");
    }

    public void setReasoningEffort(String effort) {
        sp.edit().putString(KEY_REASONING_EFFORT, effort).apply();
    }

    public Set<String> getCachedModels() {
        return sp.getStringSet(KEY_CACHED_MODELS, new HashSet<>());
    }

    public void setCachedModels(Set<String> models) {
        sp.edit().putStringSet(KEY_CACHED_MODELS, models).apply();
    }
}
